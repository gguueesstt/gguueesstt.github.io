...
EXCITER is an ongoing optical sound experiment, where animations are printed onto 16mm film frame by frame, using the [DIY frame printing process](https://gguueesstt.github.io/frameprinter/).
The first animation was made in TouchDesigner, using scans of a [book about moirée illusions](https://www.goodreads.com/book/show/2446119.Optical_Designs_in_Motion_with_Moire_Overlays). 

![Images of exciter 16mm film strips](/imgs/strips.png)
